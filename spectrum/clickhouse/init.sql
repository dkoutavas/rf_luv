...
SELECT * FROM (
    ...
    UNION ALL SELECT 177000000, 1000000, 'DVB-T / DAB+', 'broadcast', 'digital', 'Digital TV/radio from Hymettus'
    UNION ALL SELECT 186000000, 1000000, 'DVB-T Band III', 'broadcast', 'digital', 'Digital TV from Hymettus'
    UNION ALL SELECT 198000000, 1000000, 'DVB-T Band III', 'broadcast', 'digital', 'Digital TV upper band'
